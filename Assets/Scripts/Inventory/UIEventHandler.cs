...
public class UIEventHandler : MonoBehaviour
{
    ...
    {
        Debug.Log("ItemEquipped itemss:" + item.ItemName);
        OnItemEquipped(item);
    }

    public static void HealthChanged(int currentHealth, int maxHealth)
    {
        Debug.Log("CharacterHealth changed:" + currentHealth + "/" + maxHealth);
        OnPlayerHealthChanged(currentHealth, maxHealth);
    }

    public static void StatsChanged()
    {
        Debug.Log("characterStats changed");
        OnStatsChanged();
    }

    public static void PlayerLevelChanged()
    {
        Debug.Log("characterLevels changed");
        OnPlayerLevelChange();
    }
}
